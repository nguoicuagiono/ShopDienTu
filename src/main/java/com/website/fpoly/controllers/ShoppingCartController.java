...
import com.website.fpoly.Utils.Utils;
...
import com.website.fpoly.model.ProductInfo;
...
//			}
	...
	// ĐĂNG NHẬP KHÁCH HÀNG ĐỂ COMMENT
	
	@RequestMapping(value = {"/login_customer"}, method = RequestMethod.GET)
	public String loginCustomer(Model model) {
		model.addAttribute("login_custonmer", new Customer());
		return "login_customer";
	}
	
	@RequestMapping(value = {"/login_customer"}, method = RequestMethod.POST)
	public String loginCustomer(Model model, HttpSession session, @ModelAttribute("login_customer") Customer cus) {
//		Customer cus = customerService.searchCustomerByFullNameAndPhoneNumber(fullNameandPhonenumber)
		return "login_customer";
	}
