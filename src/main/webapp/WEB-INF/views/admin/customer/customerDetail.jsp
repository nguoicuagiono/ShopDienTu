...
<body>
	...
	<div class="form-default">
					...
					<div id="loginbox" class="loginbox">
						<form action="" method="post" name="login" id="login-form">
						  <fieldset class="input">
						    <div class="row">
				<div class="col">
					<label><i class="fa fa-address-book"></i> 	Tên: </label>
			...
			<div class="row">
				<div class="col">
					<label><i class="fa fa-mobile-alt"></i> 	SĐT:</label>
				</div>
				<div class="col"> ${customer.numberPhone}</div>
			</div>
			<div class="row">
				...
				<div class="col"> ${customer.email}</div>
						    ...
						    <div class="remember">
							    <%-- <input formaction="<c:url value='/admin/customer/getCustomer/${customer.id}?mode=EDIT' />" type="submit" name="Submit" class="button" value="Cập nhật">
							    <input formaction="/admin/customer/" type="Reset" name="Submit" class="button" value="Reset"><div class="clear"></div> --%>
							 <a	href="<c:url value='/admin/customer/getCustomer/${customer.id}?mode=EDIT' />" class="btn btn-primary"><i class="fas fa-save"></i> Cập nhật</a>
