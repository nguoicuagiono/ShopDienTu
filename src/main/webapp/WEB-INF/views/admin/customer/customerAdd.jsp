			...
			<form:form enctype="multipart/form-data" method="POST"
				...
				<div class="form-group">
					...
					<form:input path="numberPhone" type="text" class="form-control" 
						pattern="[0-9]{6,11}"
						title="Sô điện không hợp lệ hoặc sô điện thoại phải có từ 6 đến 11 chữ số" placeholder="Số điện thoại"
						id="numberPhone" />
				</div>
				<div class="form-group">
					<label for="street">Đường:</label>
					<form:input path="street" type="text" class="form-control" placeholder="Đường"
						id="street" />
				</div>
				<div class="form-group">
					<label for="district">Quận,huyện:</label>
					<form:input path="district" type="text" class="form-control" placeholder="Quận,huyện"
						id="district" />
				</div>
				<div class="form-group">
					<label for="city">Tỉnh/Thành phố:</label>
					<form:input path="city" type="text" class="form-control" placeholder="Tỉnh, Thành phố" id="city" />
				</div>
				<div class="form-group">
				...
				<div class="btn-group">
					...
					<button type="reset" class="btn btn-light" value="Reset">
						<a href="/admin/customer/"><i class="fas fa-undo"></i> Quay lại</a>
					</button>
				</div>
