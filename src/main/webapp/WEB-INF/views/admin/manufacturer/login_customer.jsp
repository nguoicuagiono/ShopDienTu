		...
		<div class="login-html">
			...
			<div class="login-form">
				...
				<div class="sign-in-htm">
					<form class="form-signin" method="post" action="login_customer">
						<div>
				...
				<div class="for-pwd-htm">
					<form method="post" action="register_customer">
						...
						<div class="group">
							<label for="password" class="label">Mật khẩu:</label> <input
								id="password" name="password" type="text" class="input">
						</div>
						
						<div class="group">
							<label for="nhapLaiMatKhau" class="label">Nhập lại mật khẩu:</label> <input
								id="nhapLaiMatKhau" name="nhapLaiMatKhau" type="text" class="input">
						</div>
						<div class="group">
