...
<body>
<ul class="breadcrumb breadcrumb__t"><a class="home" href="/shop/">Trang chủ</a> / Giỏ Hàng </ul>
	...
	<c:choose>
			...
			<div class="cart-main-area ptb-40">
				<div class="container">
					<div class="cart-main-area ptb-40">
						<div class="container">
							<div class="row">
								<div class="col-sm-4 col-lg-12 md-12">
															...
															<tr>
																<td data-th="Image">
																	<div class="row-cart">
																			...
																			<img class="product-image" width="75" height="75"
		...
		<c:otherwise>
			<div class="p-3">
			<center><img src="/uploads/empty.gif" height="200" width="200"/>
				<div class="alert alert-danger">Giỏ hàng chưa có sản phẩm!!</div></center>
			</div>
		</c:otherwise>
	</c:choose>
	</div>
