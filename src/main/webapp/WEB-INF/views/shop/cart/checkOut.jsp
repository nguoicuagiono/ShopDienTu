...
<body>
<ul class="breadcrumb breadcrumb__t"><a class="home" href="/shop/">Trang chủ</a> / Đặt Hàng </ul>
					...
					<div class="col-sm-4 col-lg-12 md-12">
						<div class="checkout-form">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="checkout-form-list">
										...
										<form:input path="firstName" id="customer.firstName"
											...
											value="Họ" maxlength="32" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Họ';}"/>
								...
								<div class="col-md-6">
									<div class="checkout-form-list">
										<button id="submitOrder" type="submit" class="grey"> Tạo hóa đơn </button>
									</div>
								</div>
							</div>
						</div>
