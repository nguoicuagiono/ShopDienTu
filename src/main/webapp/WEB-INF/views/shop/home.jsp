				...
				<div class="cont span_2_of_3">
					...
					<c:forEach items="${products.getContent()}" var="p">
						<div class="top-box">
							...
							<div class="col_1_of_3 span_1_of_3 mr-3 ">
								<a
									href="<c:url value='/shop/getProduct/${p.productCode}?mode=VIEW' />">
									<div class="inner_content clearfix">
										<div class="product_image">
											<img src="<c:url value="/uploads/${p.productImages}" />"
												alt="" width="300px" height="273px" />
										</div>
										<div class="sale-box">
										...
										<div class="price">
											<div class="cart-left">
												...
												<div class="price1">
													<span class="actual"> <fmt:formatNumber
															type="currency" value="${p.newPrice}"></fmt:formatNumber>
													</span>
												</div>
											</div>
					...
					<div class="border">
						...
						<div class="slider-wrapper theme-default">
							<div id="slider" class="nivoSlider">
								<img src="/uploads/t-img1.jpg " alt="" />
								 <img src="/uploads/t-img2.jpg" alt="" /> 
								 <img src="/uploads/t-img3.jpg " alt="" />
							</div>
						</div>
